...
export const UploadDemographicEvolutionCustom = ({ epciCode }: UploadDemographicEvolutionProps) => {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setQueryStates({
        demographicEvolutionOmphaleCustomIds: [
          ...queryStates.demographicEvolutionOmphaleCustomIds,
          result.id,
        ],
      })
