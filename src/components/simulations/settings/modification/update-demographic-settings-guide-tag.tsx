...
export const UpdateDemographicSettingsGuideTag: FC<UpdateGuideTagProps> = ({ step }) => {
    ...
    return (
      <>
        ...
        <Tag className={classes.tag} iconId="ri-home-4-line" linkProps={{ href }}>
          Décohabitation: {formattedDecohabitation}
        </Tag>
      </>
    )
  }
  ...
  if (path.includes('taux-cibles-logements')) {
    ...
    // Return empty tags when no rates available
    return (
      <>
        <Tag className={classes.tag} iconId="ri-home-4-line" linkProps={{ href }}>
          Taux cible logements vacants: -
        </Tag>
        <Tag className={classes.tag} iconId="ri-home-line" linkProps={{ href }}>
          Taux cible résidences secondaires: -
        </Tag>
      </>
    )
  }
