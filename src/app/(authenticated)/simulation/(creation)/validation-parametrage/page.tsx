...
import { CreateSimulationForm } from '~/components/simulations/create-simulation-form'
...
export default async function ValidationParametragePage({ searchParams }: PageProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', paddingBottom: '1rem', paddingTop: '1rem' }}>
