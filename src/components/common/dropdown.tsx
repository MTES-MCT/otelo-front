...
): event is React.KeyboardEvent<HTMLDivElement> => Object.prototype.hasOwnProperty.call(event, 'key')
  ...
  return (
    <>
      <div className="fr-hidden-md">
        <Button
          className={classNames(displayDropdownArrow ? 'fr-dropdown__btn' : '', modalControlClassName)}
      ...
      <div className="fr-dropdown fr-hidden fr-unhidden-md">
        <Button
          className={classNames(displayDropdownArrow ? 'fr-dropdown__btn' : '', dropdownControlClassName)}
          priority={priority}
          title={title}
          type="button"
          size={size}
